...
### Utilities (`utilities/`)
- **context-fetcher** - Smart information retrieval without context bloat
...
**Utilities** (`utilities/`): Handle mechanical tasks, reduce context overhead, enable focus on core logic
